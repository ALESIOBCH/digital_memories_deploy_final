...
document.querySelectorAll('.example-card .btn').forEach((btn, index) => {
    btn.addEventListener('click', () => {
        const examples = [
            'anniversary-example.html',
            'friend-example.html',
            'employee-example.html'
        ];
        
        // In a real app, you'd navigate to the example page
...
document.querySelectorAll('.pricing-card .btn').forEach((btn, index) => {
    btn.addEventListener('click', () => {
        const plans = ['Básico', 'Premium', 'Corporativo'];
        alert(`Você selecionou o plano ${plans[index]}. Redirecionando para o checkout...`);
    });
});
